        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-white border border-slate-200 p-12 shadow-lg shadow-slate-200/50">
            ...
            <div className="relative text-center">
              ...
              {/* Badge */}
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 border border-indigo-200 rounded-full text-indigo-700 text-sm mb-6">
              ...
              <div className="grid sm:grid-cols-3 gap-4 max-w-2xl mx-auto mb-10">
                {[
                  ...
                  <div key={i} className="p-4 bg-slate-50 rounded-xl border border-slate-200">
                    <p className="font-medium text-slate-900 mb-1">{feature.title}</p>
              ...
              {/* Notify me button */}
              <button className="inline-flex items-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-500 rounded-xl font-medium text-white transition-all shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/30">
              ...
              <div className="mt-12 flex justify-center gap-4">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className={`w-32 h-40 bg-white rounded-xl border border-slate-200 p-3 transform shadow-sm ${i === 2 ? 'scale-110 z-10' : 'opacity-60'
                      }`}
                    style={{ transform: `rotate(${(i - 2) * 5}deg)` }}
                  >
                    <div className="h-4 bg-slate-200 rounded mb-2" />
                    <div className="h-16 bg-slate-50 rounded border border-dashed border-slate-300" />
